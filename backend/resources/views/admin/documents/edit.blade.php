...
<div class="doc-form-page edit-mode">
    ...
    <div class="doc-form-header">
        ...
        <div>
            ...
            <p>
                Actualiza información, enlaces y visibilidad
            ...
            <div class="doc-card">
                ...
                <div class="doc-group">
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Describe brevemente el contenido del documento...">{{ old('description', $document->description) }}</textarea>
                ...
                <div class="doc-group">
                    ...
                    <select name="type"
                        ...
                        <option value="rendicion"
                            {{ old('type', $document->type) == 'rendicion' ? 'selected' : '' }}>
                        ...
                        <option value="poa"
                            {{ old('type', $document->type) == 'poa' ? 'selected' : '' }}>
                        ...
                        <option value="pei"
                            {{ old('type', $document->type) == 'pei' ? 'selected' : '' }}>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function detectProvider(){
        ...
        else if(value.includes('dropbox')){
    ...
    url.addEventListener('input', detectProvider);
